  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          AppStrings.get('account_title').toUpperCase(),
        ...
        actions: [
          IconButton(
            ...
            tooltip: AppStrings.get('account_logout'),
            onPressed: signOut,
          ),
        ],
      ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                // ПОЧТА
                Text(
                  firebaseUser?.email ?? AppStrings.get('account_unknown'),
                  style: TextStyle(
                    fontSize: 18,
            ...
            child: SizedBox(
              ...
              child: InkWell(
                ...
                child: Ink(
                  ...
                  child: Center(
                    child: Text(
                      AppStrings.get('account_settings'),
                      style: const TextStyle(
                        fontSize: 18,
